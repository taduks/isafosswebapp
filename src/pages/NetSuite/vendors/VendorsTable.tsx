...
import VendorDto from "../../../services/types/VendorDto";
...
function Vendors () {
    ...
    const {isLoading: isLoading, data: data, error: error} = useQuery<VendorDto, Error>(
        "query-vendors",
        async () => {
            return await VendorService.findAll(accessToken);
        },
    );
